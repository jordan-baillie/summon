...
describe("Coding Agent Tools", () => {
	...
	describe("edit tool", () => {
		...
		it.skipIf(!chmodDeniesAccess())("should include EACCES for read-only files", async () => {
		...
		it.skipIf(!chmodDeniesAccess())("should include EACCES in diff preview for unreadable files", async () => {
